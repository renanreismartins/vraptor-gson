...
public class GsonJSONSerialization implements JSONSerialization {
    ...
    public GsonJSONSerialization(HttpServletResponse response, TypeNameExtractor extractor, ProxyInitializer initializer, XStreamBuilder builder) {
    ...
    protected SerializerBuilder getSerializer() {
        try {
            return new GsonSerializer(getXStream(), response.getWriter(), extractor, initializer);
        } catch (IOException e) {
